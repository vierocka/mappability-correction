...
**v7 (10 variants) — deduplicated CDS reads.** Reads simulated directly from the 93,088 deduplicated CDS sequences with a step-1 sliding window. UF is per CDS sequence. Two alignment targets: full genome (v7_a–f, v7_i–j) and dedup CDS self-map (v7_g–h).
