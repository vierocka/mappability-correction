#!/bin/bash
# v7_c — dedup CDS reads | full genome | SE | 75 bp
...
OUTDIR="$SCRIPT_DIR/../results/mappability_dedup_cds_reads_SE_L75bp"
THREADS=64
READ_LEN=75
...
echo "════════════════════════════════════════════════════════"
echo "Mappability — v7_c (dedup CDS reads, full genome, SE, 75 bp)"
...
out = outdir / "cds_uniqueness_factors_genome_SE_L75bp.tsv"
...
echo "════════════════════════════════════════════════════════"
echo "Done: $OUTDIR/cds_uniqueness_factors_genome_SE_L75bp.tsv"
echo "════════════════════════════════════════════════════════"
