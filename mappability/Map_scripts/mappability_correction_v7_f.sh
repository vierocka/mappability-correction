#!/bin/bash
# v7_f — dedup CDS reads | full genome | PE | 150 bp
...
OUTDIR="$SCRIPT_DIR/../results/mappability_dedup_cds_reads_PE_L150bp"
THREADS=64
READ_LEN=150
...
echo "════════════════════════════════════════════════════════"
echo "Mappability — v7_f (dedup CDS reads, full genome, PE, 150 bp)"
...
out = outdir / "cds_uniqueness_factors_genome_PE_L150bp.tsv"
...
echo "════════════════════════════════════════════════════════"
echo "Done: $OUTDIR/cds_uniqueness_factors_genome_PE_L150bp.tsv"
echo "════════════════════════════════════════════════════════"
