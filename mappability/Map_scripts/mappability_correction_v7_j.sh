#!/bin/bash
# v7_j — dedup CDS reads | full genome | PE | 200 bp
...
OUTDIR="$SCRIPT_DIR/../results/mappability_dedup_cds_reads_PE_L200bp"
THREADS=64
READ_LEN=200
...
echo "════════════════════════════════════════════════════════"
echo "Mappability — v7_j (dedup CDS reads, full genome, PE, 200 bp)"
...
out = outdir / "cds_uniqueness_factors_genome_PE_L200bp.tsv"
...
echo "════════════════════════════════════════════════════════"
echo "Done: $OUTDIR/cds_uniqueness_factors_genome_PE_L200bp.tsv"
echo "════════════════════════════════════════════════════════"
