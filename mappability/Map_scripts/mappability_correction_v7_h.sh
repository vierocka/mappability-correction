#!/bin/bash
# v7_h — dedup CDS reads | dedup CDS self-map | PE | 100 bp
...
OUTDIR="$SCRIPT_DIR/../results/mappability_dedup_cds_reads_selfmap_PE"
THREADS=64
READ_LEN=100
...
echo "════════════════════════════════════════════════════════"
echo "Mappability — v7_h (dedup CDS reads, dedup CDS self-map, PE, 100 bp)"
...
echo ""
echo "Step 1: Simulating reads from dedup CDS FASTA (PE, READ_LEN=$READ_LEN)..."
...
echo ""
echo "Step 2: STAR alignment (PE, dedup CDS self-map, $THREADS threads)..."
...
out = outdir / "cds_uniqueness_factors_selfmap_PE.tsv"
...
echo "════════════════════════════════════════════════════════"
echo "Done: $OUTDIR/cds_uniqueness_factors_selfmap_PE.tsv"
echo "════════════════════════════════════════════════════════"
